...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "bachelor@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "bachelor API";

        private String description = "bachelor API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "bachelor";
